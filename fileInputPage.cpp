  ...
  QWizardPage (parent)
{
  ...
  setTitle (tr ("czmil2LAS File Input"));
...
{
  QFileDialog fd (this, tr ("czmil2LAS Input files"));
  fd.setViewMode (QFileDialog::List);
  fd.setDirectory (input_dir);

  fd.setFileMode (QFileDialog::ExistingFiles);
  fd.setNameFilter (QString ("CZMIL CPF (*.cpf)"));
...
{
  QString title = tr ("czmil2LAS Input directories");
